...
export function MetaMaskGate({ children }: { children: React.ReactNode }) {
  ...
  if (checking) {
    return (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100vh", background: "#000", color: "#6F6E63", fontFamily: "system-ui", fontSize: 13 }}>
        Detecting wallet…
      </div>
    );
  }
...
export function ERC7715Badge() {
  ...
  return (
    <span style={{
      ...
      background: ok ? "rgba(164,110,219,0.1)" : "rgba(242,184,92,0.12)",
      color: ok ? "#A46EDB" : "#F2B85C",
      border: `1px solid ${ok ? "rgba(164,110,219,0.25)" : "rgba(242,184,92,0.3)"}`,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        padding: "36px 40px", maxWidth: 480, width: "90%", color: "#F0EDF5",
      }}>
        {/* Header */}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <a
            ...
            style={{
              ...
              padding: "12px 20px", borderRadius: 9, background: "#A46EDB", color: "#000",
