        ...
        {agent.registryId && (
          <div style={{ marginTop: 8, display: "flex", flexDirection: "column", gap: 3 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <span style={{ fontSize: 9, padding: "2px 6px", borderRadius: 3, background: "rgba(164,110,219,0.10)", border: "1px solid rgba(164,110,219,0.25)", color: ACCENT, letterSpacing: "0.04em", textTransform: "uppercase", fontWeight: 600 }}>
                Registered
              </span>
