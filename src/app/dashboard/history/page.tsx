  ...
  return (
    <div style={{
      ...
      <aside style={{ borderRight: `1px solid ${LINE}`, padding: "18px 16px", display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <div style={{ fontSize: 11, color: MID, letterSpacing: "0.05em", textTransform: "uppercase", marginTop: 8 }}>
          Workflows
        </div>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: sel ? "rgba(164,110,219,0.06)" : "transparent",
                  border: `1px solid ${sel ? "rgba(164,110,219,0.25)" : LINE_MID}`,
          ...
          return (
            <>
              <div style={{ marginBottom: 28, display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 18 }}>
                <div>
                  <div style={{ fontSize: 11, color: MID, letterSpacing: "0.05em", textTransform: "uppercase", marginBottom: 6 }}>
                    Workflow
                  </div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 10, color: MID, letterSpacing: "0.04em", textTransform: "uppercase", marginBottom: 14 }}>
