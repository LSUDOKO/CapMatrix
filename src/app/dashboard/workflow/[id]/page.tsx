...
function AgentMiniNode({ data }: { data: Agent & { onOpen: () => void } }) {
  ...
  const border = isLive ? "rgba(164,110,219,0.4)" : LINE_MID;
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: isLive ? `0 0 0 1px rgba(164,110,219,0.25), 0 8px 18px -10px ${ACCENT_GLOW}` : "none",
        transition: "border-color .15s, box-shadow .15s",
        fontFamily: "var(--sans)",
      }}
    >
      <Handle type="target" position={Position.Left} style={{ width: 6, height: 6, background: border, left: -3 }} />
      <div style={{ display: "flex", alignItems: "center", gap: 5, fontSize: 9, color: MID, letterSpacing: "0.05em", textTransform: "uppercase", marginBottom: 6 }}>
...
function DelegationTag({ label, context }: { label: string; context?: string }) {
  ...
  return (
    <div style={{
      ...
      background: "rgba(164,110,219,0.06)", border: `1px solid ${ACCENT}33`,
      ...
      {history.length > 0 && (
        <div style={{ marginTop: isActive ? 40 : 0 }}>
          <div style={{
            ...
            fontSize: 9.5, color: MID, letterSpacing: "0.04em", textTransform: "uppercase",
          }}>
  ...
  return (
    <div style={{ background: INK_1, border: `1px solid ${isLive ? color + "66" : LINE_MID}`, borderRadius: 12, padding: 16,
      ...
      <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 12 }}>
        ...
        <span style={{ fontSize: 10.5, background: "rgba(20,21,16,0.05)", color: TEXT2, padding: "3px 10px", borderRadius: 20 }}>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ background: INK_1, border: `1px solid ${LINE_MID}`, borderRadius: 12, padding: "16px 18px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
          <span style={{ width: 32, height: 32, borderRadius: 8, background: "rgba(20,21,16,0.05)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16 }}>🏦</span>
          <div style={{ flex: 1 }}>
    ...
    <div style={{
        ...
        <section style={{ position: "relative", overflow: "hidden" }}>
          ...
          {allocResult && (
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
                <span style={{ fontSize: 11, letterSpacing: "0.05em", textTransform: "uppercase", color: "#B9A8FF", fontWeight: 700 }}>⚖️ Fund Manager allocation</span>
      ...
      {tab === "history" && (
        <section style={{ overflowY: "auto", padding: "28px 40px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 10, color: MID, letterSpacing: "0.04em", textTransform: "uppercase", marginBottom: 16 }}>
