  ...
  return (
    <div style={{ minHeight: "100vh", background: PAPER, color: INK, padding: "48px 24px" }}>
      <div style={{ maxWidth: 760, margin: "0 auto" }}>
        <div style={{ fontSize: 11, textTransform: "uppercase", letterSpacing: "0.18em", color: "#8C8B7E", marginBottom: 8 }}>
          A2A · On-chain enforced caps
        </div>
        <h1 style={{ fontSize: 40, fontWeight: 600, letterSpacing: "-0.03em", margin: "0 0 12px" }}>
          Overspend proof
        </h1>
        <p style={{ fontSize: 15, lineHeight: 1.6, color: "#E2DDD0", maxWidth: "60ch" }}>
        ...
        <div style={{ marginTop: 32, display: "grid", gap: 16 }}>
          ...
          <Card n="2" title="Grant to the Fund Manager">
            <div style={{ fontSize: 13, color: "#8C8B7E", marginBottom: 10 }}>
          ...
          <Card n="3" title="Try to overspend">
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
              ...
              <button
                ...
                disabled={!!busy}
                style={{ padding: "9px 14px", borderRadius: 10, border: "1px solid rgba(14,15,12,0.2)", background: "transparent", color: "#8C8B7E", fontSize: 13, cursor: busy ? "not-allowed" : "pointer" }}
                title="Show the recorded mainnet result — demo-safe even if the relayer is down"
              >
                ⏺ Replay recorded result
              </button>
            </div>
            <div style={{ fontSize: 11, color: "#8C8B7E", marginTop: 8 }}>
        ...
        {busy && <p style={{ marginTop: 20, fontSize: 13, color: "#8C8B7E" }}>{busy}</p>}
        ...
        {result && (
          <div style={{
            ...
            {result.replayNote && <p style={{ fontSize: 12.5, lineHeight: 1.5, margin: "0 0 8px", color: "#8C8B7E", fontStyle: "italic" }}>{result.replayNote}</p>}
            ...
            {result.note && <p style={{ fontSize: 14, lineHeight: 1.55, margin: "0 0 14px", color: "#E2DDD0" }}>{result.note}</p>}
            {result.hint && <p style={{ fontSize: 13, lineHeight: 1.5, margin: "0 0 14px", color: "#8C8B7E" }}>{result.hint}</p>}
            ...
            <details style={{ marginTop: 10 }}>
              <summary style={{ fontSize: 12, color: "#8C8B7E", cursor: "pointer" }}>Raw response</summary>
          ...
          {adv && (
            <div style={{
              ...
              <div style={{ marginBottom: 14 }}>
                ...
                <div style={{ fontSize: 13, color: "#E2DDD0", lineHeight: 1.5, padding: "8px 11px", borderRadius: 8, background: "rgba(124,92,255,0.06)", border: "1px solid rgba(124,92,255,0.22)", fontStyle: "italic" }}>
              ...
              {adv.note ? <p style={{ fontSize: 14, lineHeight: 1.55, margin: "12px 0 0", color: "#E2DDD0" }}>{String(adv.note)}</p> : null}
...
function Field({ label, value, onChange }: { label: string; value: string; onChange: (v: string) => void }) {
  return (
    <label style={{ fontSize: 12, color: "#8C8B7E" }}>
      {label}
...
function Label({ children }: { children: React.ReactNode }) {
  return <div style={{ fontSize: 11, textTransform: "uppercase", letterSpacing: "0.1em", color: "#8C8B7E", marginBottom: 3 }}>{children}</div>;
}
