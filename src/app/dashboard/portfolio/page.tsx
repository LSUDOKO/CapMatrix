...
function CloverMark({ size = 16, color = "#A46EDB" }: { size?: number; color?: string }) {
  return (
...
function Sparkline({ points, color = "#A46EDB", w = 160, h = 60 }: { points: number[]; color?: string; w?: number; h?: number }) {
    ...
    <div className="page">
      <div className="hero-row">
        <div className="hero-stat" ref={r1 as React.RefObject<HTMLDivElement>}>
          ...
          <Sparkline points={spark} color={pnlUp ? "#A46EDB" : "#FF6B5E"} />
        </div>
        ...
        {txs.length === 0 ? (
          ...
          <div className="tx-row" key={i}>
            ...
            {t.flag
              ...
              : (t.txHash
                  ? <a className="tx-hash" href={`https://basescan.org/tx/${t.txHash}`} target="_blank" rel="noopener noreferrer" style={{ color: "#A46EDB", textDecoration: "none" }}>{t.hash} ↗</a>
